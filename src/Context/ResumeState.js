...
const ResumeState = (props) => {
    ...
    } // зберігаємо занчення за замовчуванням
    ...
    return (
        <ResumeContext.Provider value={{
            ...
            currentTheme, setCurrentTheme, showComponent, setShowComponent, loading, setLoading, themeData,
            setThemeData, checkProj, checkWork, setCheckProj, setCheckWork
        }}>
            {props.children}
